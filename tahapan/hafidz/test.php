            ...
            <div class="col-md-10 col-xl-6 col-sm-12 mt-3">
                <div class="card shadow">
                    <div class="card-header fs-6 row  justify-content-center text-center">
                        ...
                        <?php
                        // menghitung total Income
                        $queryTotalIncome = mysqli_query($koneksi, 'SELECT SUM(masuk) AS total_masuk FROM hfd');
                        $totalIncome = mysqli_fetch_assoc($queryTotalIncome)['total_masuk'];
                        ?>&nbsp;
